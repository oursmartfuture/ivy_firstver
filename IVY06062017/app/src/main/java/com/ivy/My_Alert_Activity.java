 ...
 */
public class My_Alert_Activity extends Activity implements View.OnClickListener, CallBackListenar {
    private static final int MARKORCANCEL = 2111;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        params = new Bundle();
        context = My_Alert_Activity.this;
...
//        no_record = (TextView) findViewById(R.id.no_record);
        ...
        headerText.setText(R.string.alert);
        GlobalMethod.AcaslonProSemiBoldTextView(My_Alert_Activity.this, headerText);

        if (SimpleHttpConnection.isNetworkAvailable(My_Alert_Activity.this)) {
            ...
            new AsyncTaskApp(My_Alert_Activity.this, My_Alert_Activity.this, Urls.my_notification_list, "Listing_Alerts").execute(params);
        } else {
            GlobalMethod.showToast(My_Alert_Activity.this, Constant.network_error);
        }
...
//
                    ...
                    public void onClick(View v) {
                        try {
                            if (innerJsonObj.get(position).getString("redirection").equalsIgnoreCase("0")) {
                                ...
                                GlobalMethod.showToast(My_Alert_Activity.this, getString(R.string.already_safe));
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
    ...
    private void openActivity(String json) {
        ...
        try {
            ...
            Intent notificationIntent = new Intent(My_Alert_Activity.this, Emergency_Activity.class);
